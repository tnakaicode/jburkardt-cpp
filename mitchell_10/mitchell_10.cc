...
template<int dim>
Problem10<dim>::Problem10():
    fe(FE_Q<dim>(2), 1),
    dof_handler(mesh)
{}

template<int dim>
void Problem10<dim>::read_inputs()
{
...
template<int dim>
void Problem10<dim>::setup_geometry (int cycle)
{  		
	if (cycle == 0)
	{
		mesh.clear();
...
template<int dim>
void Problem10<dim>::assemble_and_solve()
{
...
template<int dim>
void Problem10<dim>::refine_grid(int cycle, const char *s)
{
	if (cycle == 0)
	{
		setup_geometry(0);
...
template<int dim>
void Problem10<dim>::output_results(int cycle, const char *s)
{	
...
template<int dim>
void Problem10<dim>::calculate_error(int cycle, ConvergenceTable &error_table)
{	
...
template<int dim>
void Problem10<dim>::run()
{	
	read_inputs(); 
	
	forcing_function->a = input.a;	
	forcing_function->b = input.b;	
	boundary_function->a = input.a;	
	boundary_function->b = input.b;	
	exact_solution->a = input.a;
	exact_solution->b = input.b;
...
template<int dim>
void Problem10<dim>::print_errors(bool convergence_study, ConvergenceTable error_table)
{
