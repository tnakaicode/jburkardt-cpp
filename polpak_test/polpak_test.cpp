...
//
{
  ...
  cout << "\n";
  cout << "BELL_POLY_COEF_TEST\n";
  cout << "  BELL_POLY_COEF returns the coefficients of a\n";
  cout << "  Bell polynomial.\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "DELANNOY_TEST\n";
  cout << "  DELANNOY computes the Delannoy numbers A(0:M,0:N).\n";
  cout << "  A(M,N) counts the paths from (0,0) to (M,N).\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "DOMINO_TILING_NUM_TEST:\n";
  cout << "  DOMINO_TILING_NUM returns the number of tilings of an\n";
  cout << "  MxN rectangle by dominoes.\n";
  cout << "\n";
  cout << "   M   N    Tilings\n";
...
//
{
  ...
  cout << "\n";
  cout << "I4_IS_FIBONACCI_TEST\n";
  cout << "  I4_IS_FIBONACCI determines if an I4 is a Fibonacci number.\n";
  cout << "\n";
  cout << "   I4       T/F\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "I4_TO_TRIANGLE_LOWER_TEST\n";
  cout << "  I4_TO_TRIANGLE_LOWER converts a linear index to a\n";
  cout << "  lower triangular one.\n";
  cout << "\n";
  cout << "     K  => I     J\n";
  cout << "\n";
...
# define SLICE_MAX 8
  ...
  cout << "\n";
  cout << "SLICES_TEST:\n";
  cout << "  SLICES determines the maximum number of pieces created\n";
...
//
{
  ...
  cout << "\n";
  cout << "TRIANGLE_LOWER_TO_I4_TEST\n";
  cout << "  TRIANGLE_LOWER_TO_I4 converts a lower triangular index to a\n";
  cout << "  linear one.\n";
  cout << "\n";
  cout << "     I     J ==>   K\n";
  cout << "\n";
...
# define N 20
  ...
  cout << "\n";
  cout << "TRIBONACCI_RECURSIVE_TEST\n";
  cout << "  TRIBONACCI_RECURSIVE computes the Tribonacci sequence.\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "ZETA_M1_TEST\n";
  cout << "  ZETA_M1 computes the Zeta Minus One function.\n";
  cout << "  Requested relative accuracy= " << tol << "\n";
  cout << "\n";
  cout << "       P            Zeta_M1(P)         Zeta_M1(P)\n";
  cout << "                    tabulated          computed.\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "ZETA_NAIVE_TEST\n";
  cout << "  ZETA_NAIVE computes the Zeta function.\n";
  cout << "\n";
