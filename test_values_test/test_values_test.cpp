...
//
  ...
  cout << "\n";
  cout << "C8_LOG_VALUES_TEST:\n";
  cout << "  C8_LOG_VALUES stores values of \n";
  cout << "  the logarithm of a complex value.\n";
  cout << "\n";
  cout << "                Z                     FZ\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "EASTER_GREGORIAN_VALUES_TEST:\n";
  cout << "  EASTER_GREGORIAN_VALUES returns values of \n";
  cout << "  the date of Easter in the Gregorian calendar.\n";
  cout << "\n";
  cout << "   D   M      Y\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "EASTER_JULIAN_VALUES_TEST:\n";
  cout << "  EASTER_JULIAN_VALUES returns values of \n";
  cout << "  the date of Easter in the Julian calendar.\n";
  cout << "\n";
  cout << "   D   M      Y\n";
  cout << "\n";
...
//
{
  ...
  cout << "  kind, with parameter angle A in degrees.\n";
  cout << "\n";
  cout << "    A            E(A)\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "ELLIPTIC_EK_VALUES_TEST:\n";
  cout << "  ELLIPTIC_EK_VALUES stores values of\n";
  cout << "  the complete elliptic integral of the second\n";
...
//
{
  ...
  cout << "\n";
  cout << "ELLIPTIC_FA_VALUES_TEST:\n";
  cout << "  ELLIPTIC_FA_VALUES stores values of\n";
...
//
{
  ...
  cout << "\n";
  cout << "ELLIPTIC_FK_VALUES_TEST:\n";
  cout << "  ELLIPTIC_FK_VALUES stores values of\n";
  cout << "  the complete elliptic integral of the first\n";
  cout << "  kind, with parameter K.\n";
  cout << "\n";
  cout << "    K            F(K)\n";
...
//
{
  ...
  cout << "\n";
  cout << "ELLIPTIC_FM_VALUES_TEST:\n";
  cout << "  ELLIPTIC_FM_VALUES stores values of\n";
  cout << "  the complete elliptic integral of the first\n";
  cout << "  kind, with parameter modulus M.\n";
  cout << "\n";
  cout << "      M            F(M)\n";
...
//
  ...
  cout << "\n";
  cout << "ELLIPTIC_INC_EA_VALUES_TEST:\n";
  cout << "  ELLIPTIC_INC_EA_VALUES stores values of\n";
  cout << "  the incomplete elliptic integral of the second\n";
  ...
  while ( true )
  {
    ...
    cout << "  " << setw(12) << setprecision(6) << phi
         << "  " << setw(12) << setprecision(6) << a 
         << "  " << setw(24) << setprecision(16) << ea << "\n";
  }
//
//  Restore the default precision.
//
...
//
  ...
  cout << "\n";
  cout << "ELLIPTIC_INC_EK_VALUES_TEST:\n";
  cout << "  ELLIPTIC_INC_EK_VALUES stores values of\n";
  cout << "  the incomplete elliptic integral of the second\n";
  ...
  while ( true )
  {
    ...
    cout << "  " << setw(12) << setprecision(6) << phi
         << "  " << setw(12) << setprecision(6) << k 
         << "  " << setw(24) << setprecision(16) << -ek << "\n";
  }
//
//  Restore the default precision.
//
...
//
  ...
  cout << "\n";
  cout << "ELLIPTIC_INC_EM_VALUES_TEST:\n";
  cout << "  ELLIPTIC_INC_EM_VALUES stores values of\n";
  cout << "  the incomplete elliptic integral of the second\n";
  ...
  while ( true )
  {
    ...
    cout << "  " << setw(12) << setprecision(6) << phi
         << "  " << setw(12) << setprecision(6) << m
         << "  " << setw(24) << setprecision(16) << em << "\n";
  }
//
//  Restore the default precision.
//
...
//
  ...
  cout << "\n";
  cout << "ELLIPTIC_INC_FA_VALUES_TEST:\n";
  cout << "  ELLIPTIC_INC_FA_VALUES stores values of\n";
...
//
  ...
  cout << "\n";
  cout << "ELLIPTIC_INC_FK_VALUES_TEST:\n";
  cout << "  ELLIPTIC_INC_FK_VALUES stores values of\n";
  cout << "  the incomplete elliptic integral of the first\n";
  cout << "  kind, with parameters PHI, K.\n";
  cout << "\n";
  cout << "    PHI        K            F(PHI,K)\n";
...
//
  ...
  cout << "\n";
  cout << "ELLIPTIC_INC_FM_VALUES_TEST:\n";
  cout << "  ELLIPTIC_INC_FM_VALUES stores values of\n";
  cout << "  the incomplete elliptic integral of the first\n";
  cout << "  kind, with parameters PHI, M.\n";
  cout << "\n";
  cout << "    PHI        M            F(PHI,M)\n";
...
//
  ...
  cout << "\n";
  cout << "ELLIPTIC_INC_PIA_VALUES_TEST:\n";
  cout << "  ELLIPTIC_INC_PIA_VALUES stores values of\n";
  cout << "  the incomplete elliptic integral of the third\n";
  cout << "  kind, with parameters PHI, N and A.\n";
  cout << "\n";
  cout << "    PHI           N             A            Pi(PHI,N,A)\n";
  cout << "\n";
  ...
  while ( true )
  {
    ...
    cout << "  " << setw(12) << setprecision(6) << phi
         << "  " << setw(12) << setprecision(6) << n
         << "  " << setw(12) << setprecision(6) << a
         << "  " << setw(24) << setprecision(16) << pia << "\n";
  }
//
//  Restore the default precision.
//
...
//
  ...
  cout << "\n";
  cout << "ELLIPTIC_INC_PIK_VALUES_TEST:\n";
  cout << "  ELLIPTIC_INC_PIK_VALUES stores values of\n";
  cout << "  the incomplete elliptic integral of the third\n";
  cout << "  kind, with parameters PHI, N and K.\n";
  cout << "\n";
  cout << "    PHI           N             K            Pi(PHI,N,K)\n";
  cout << "\n";
...
//
  ...
  cout << "\n";
  cout << "ELLIPTIC_INC_PIM_VALUES_TEST:\n";
  cout << "  ELLIPTIC_INC_PIM_VALUES stores values of\n";
  cout << "  the incomplete elliptic integral of the third\n";
  cout << "  kind, with parameters PHI, N and M.\n";
  cout << "\n";
  cout << "    PHI           N             M            Pi(PHI,N,M)\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "ELLIPTIC_PIA_VALUES_TEST:\n";
  cout << "  ELLIPTIC_PIA_VALUES stores values of\n";
  cout << "  the complete elliptic integral of the third\n";
  cout << "  kind, with parameter angle A in degrees.\n";
  cout << "\n";
  cout << "    N             A            Pi(N,A)\n";
  cout << "\n";
  ...
  for ( ; ; )
  {
    ...
    cout << "  " << setw(12) << setprecision ( 8 ) << n
         << "  " << setw(12) << setprecision ( 8 ) << a
         << "  " << setw(24) << setprecision ( 16 ) << pia << "\n";
  }
  return;
}
...
//
{
  ...
  cout << "\n";
  cout << "ELLIPTIC_PIK_VALUES_TEST:\n";
  cout << "  ELLIPTIC_PIK_VALUES stores values of\n";
  cout << "  the complete elliptic integral of the third\n";
  cout << "  kind, with parameter K.\n";
  cout << "\n";
  cout << "    N             K            Pi(N,K)\n";
...
//
{
  ...
  cout << "\n";
  cout << "ELLIPTIC_PIM_VALUES_TEST:\n";
  cout << "  ELLIPTIC_PIM_VALUES stores values of\n";
  cout << "  the complete elliptic integral of the third\n";
  ...
  for ( ; ; )
  {
    elliptic_pim_values ( n_data, n, m, pim );
...
//
{
  ...
  for ( ; ; )
  {
    jacobi_cn_values ( n_data, u, m, fx );
...
//
{
  ...
  for ( ; ; )
  {
    jacobi_dn_values ( n_data, u, m, fx );
...
//
{
  ...
  for ( ; ; )
  {
    jacobi_sn_values ( n_data, u, m, fx );
...
//
{
  ...
  cout << "\n";
  cout << "POLYOMINO_CHIRAL_COUNT_VALUES_TEST:\n";
  cout << "  POLYOMINO_CHIRAL_COUNT_VALUES returns the number of chiral\n";
...
//
{
  ...
  cout << "\n";
  cout << "POLYOMINO_FIXED_COUNT_VALUES_TEST:\n";
  cout << "  POLYOMINO_FIXED_COUNT_VALUES returns the number of fixed\n";
  cout << "  polyominoes of a given order;\n";
...
//
{
  ...
  cout << "\n";
  cout << "POLYOMINO_FREE_COUNT_VALUES_TEST:\n";
  cout << "  POLYOMINO_FREE_COUNT_VALUES returns the number of free\n";
  cout << "  polyominoes of a given order;\n";
