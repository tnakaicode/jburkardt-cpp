...
void predator_prey_midpoint_test ( double tspan[2], double p0[2], int n );
...
void stiff_midpoint ( double tspan[2], double y0[1], int n, double t[], 
  double y[] );
void stiff_midpoint_test ( double tspan[2], double y0[1], int n );
...
//
{
  ...
  cout << "midpoint_test:\n";
  cout << "  C++ version\n";
  cout << "  Test the midpoint method on several ODE's.\n";
...
//  Purpose:
//
//    predator_prey_midpoint_test solves the predator-prey system using midpoint_fixed().
//
//  Discussion:
//
...
//
  ...
  cout << "\n";
  cout << "  predator_prey_midpoint_test: data stored in '" << data_filename << "'.\n";
//
...
//
  ...
  command << "set title 'Predator prey: midpoint'\n";
  command << "set grid\n";
  ...
  cout << "  predator_prey_midpoint_test: plot commands stored in '" << command_filename << "'.\n";
...
//
{
  ...
  t1 = new double[n+1];
  y1 = new double[n+1];
  stiff_midpoint ( tspan, y0, n, t1, y1 );
