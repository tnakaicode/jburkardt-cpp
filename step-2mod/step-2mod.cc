...
{
//
//  JVB: Consider finite_element(1), (2) or (3)
//
...
//
//  JVB: Query and print number of nonzeros and bandwidth.
//
  unsigned int nz = sparsity_pattern.n_nonzero_elements ( );
  std::cout << "  Nonzeros = " << nz << "\n";

  unsigned int bw = sparsity_pattern.bandwidth ( );
  std::cout << "  Initial bandwidth = " << bw << "\n";
