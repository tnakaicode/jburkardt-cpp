...
int main ( );
void stiff_euler_test ( double tspan[2], double y0[1], int n );
void stiff_euler_backward_test ( double tspan[2], double y0[1], int n );
...
//
{
  ...
  stiff_euler_test ( tspan, y0, n );
  stiff_euler_backward_test ( tspan, y0, n );
...
//
{
  ...
  t1 = new double[n+1];
  y1 = new double[n+1];
  stiff_euler_backward ( tspan, y0, n, t1, y1 );
